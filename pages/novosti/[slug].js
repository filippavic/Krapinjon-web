  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate="finish"
      >
        <motion.div className="flex relative justify-center w-full h-96 overflow-hidden">
        ...
        {images !== undefined ? (
          ...
          >
            <span className="text-gray-400 font-semibold">Galerija slika</span>

            <SRLWrapper options={LightboxOptions}>
              <div className="grid grid-cols-repeat gap-4 mt-5">
                {images.map((image, index) => {
                  return (
                    <div className="relative max-w-sm h-32 w-full" key={index}>
