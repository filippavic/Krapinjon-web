...
export default function NewsCard(props) {
  ...
  return (
    <motion.div
      className="flex flex-col md:flex-row bg-none hover:bg-dark-gray w-full h-72 md:h-40 mb-20 p-3 rounded-xl transition duration-300 ease-in-out hover:shadow-xl"
