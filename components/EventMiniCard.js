...
export default function EventMiniCard(props) {
  ...
  return (
    <motion.div
      className="relative flex flex-col md:flex-row hover:bg-dark-gray w-full h-60 md:h-40 mb-20 p-3 rounded-xl transition duration-300 ease-in-out hover:shadow-xl"
